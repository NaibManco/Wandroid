 ...
 */
class ArticleAdapter() : RecyclerView.Adapter<ArticleAdapter.BlogViewHolder>() {
    ...
    fun update(articles: List<Article>?) {
        articles?.apply {
            ...
            this@ArticleAdapter.articles.addAll(this)
    ...
    fun add(articles: List<Article>?) {
        articles?.apply {
            this@ArticleAdapter.articles.addAll(articles)
            notifyDataSetChanged()
        }
    }
